    ...
    return (
        <div>
            ...
            <ul style={{ ...baseTextStyle, listStylePosition: 'inside', padding: 0 }}>
                ...
                <li>Eshani</li>
                <p style={baseTextStyle}>As a passionate learner and dedicated team member, Eshani strove to bring enthusiasm and expertise to our education web application. With her extensive work on the Quiz, She hope to ensure an engaging and accessible learning experience for all!</p>
